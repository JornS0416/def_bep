"""
V-JEPA 2 — Leave-One-Dataset-Out (LODO) Evaluation
==================================================
Structurally identical to videomae_lodo.py.
Only differences: feature file, embed dim (1024 vs 3072), results dir.

See videomae_lodo.py for full rationale.

Usage
-----
    cd main_project
    python scripts/_evaluation/lodo/vjepa_lodo.py
"""
...
RESULTS_DIR   = output_root() / "results" / "lodo" / "vjepa2"
...
def main() -> None:
    ...
    output = {
        ...
        "model":      "V-JEPA 2 (ViT-L/16), frozen, mean-pool over 1568 tokens",
    ...
    json_path = RESULTS_DIR / f"results_vjepa_lodo_{run_ts}.json"
    with open(json_path, "w") as f:
        json.dump(output, f, indent=2)
    log.info("Saved to %s", json_path)

    cm_path = RESULTS_DIR / f"results_vjepa_lodo_cm_{run_ts}.csv"
