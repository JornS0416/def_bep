"""
V-JEPA — Leave-One-Subject-Out (LOSO) Evaluation
==================================================
Evaluates frozen V-JEPA ViT-L/16 mean-pool features using LOSO
cross-validation, applied per dataset separately.

Input:  vjepa_features.pkl — "feature" field: (1024,) mean-pool per clip
Output: outputs/runs/<run>/results/loso/vjepa/results_vjepa_loso_{ts}.json
...
RESULTS_DIR   = output_root() / "results" / "loso" / "vjepa"
